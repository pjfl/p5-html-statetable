...
use Sub::Exporter -setup => { exports => [ qw(
 ...
 COLUMN_META_CONFIG COLUMN_TRAIT_PREFIX COMMA DOT DQUOTE ENCODE_ENTITIES EOL
 EXCEPTION_CLASS EXTENSION_TYPE FALSE INDENT_CHARS ITERATOR_DOWNLOAD_KEY NUL
 QUERY_KEY RENDERER_CLASS RENDERER_PREFIX SERIALISE_COLUMN_ATTR
 SERIALISE_TABLE_KEY SERIALISE_TABLE_VIEW SPC TABLE_META TABLE_META_CONFIG
 TRIGGER_CLASS TRUE TYPE_EXTENSION
)]};
